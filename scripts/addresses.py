...
addresses = {
    ...
    'fr': {
        'lang':'French',
        'email': ['Michel such <michel.such@free.fr>', 'Patrick ZAJDA <patrick@zajda.fr>', 'Remy Ruiz <remyruiz@gmail.com>', 'Bachir Benanou <ben_bach@yahoo.fr>', 'Abdelkrim Bensaid <abdelkrim.bensaid@free.fr>', 'Cyrille Bougot <cyrille.bougot2@laposte.net>', 'Ali Amri <alamri86@gmail.com>', 'Corentin Bacqu&-Cazenave <corentin@progaccess33.net>'],
    },
    'ga': {
        'lang': 'Gaeilge',
    ...
    'pl': {
        'lang':'Polish',
        'email': ['Grzegorz Zlotowicz <grzezlo@wp.pl>', 'Patryk Faliszewski <patric3031@wp.pl>', 'Zvonimir Stanecic <9a5dsz@gozaltech.org>', 'Dorota Krac <dorkakrac@yandex.com>', 'Piotr Rakowski <kontakt@piotrrakowski.net>', 'Grzegorz Zlotowicz <g.zlotowicz@dzdn.pl>', 'Hubert Meyer <hubert.meyer@wp.pl>' ],
    },
    'pt_BR': {
    ...
    'ro': {
        'lang': 'Romanian',
        'email': ['Dan Pungă <dan.punga@gmail.com>', 'Florian Ionașcu <contact@florian-ionascu.ro>', 'Alexandru Matei <alexandrumateistelian@gmail.com>', 'Nicuşor Untilă <nicusoruntila@yahoo.com>', 'Adriani Ionuț Botez <ionutz_tero@yahoo.com>', 'Dragoș Grecianu <grecianu.dragos@gmail.com>', 'Daniela Popovici <vlajna95@gmail.com>'],
    },
    'ru': {
        'lang': 'Russian',
        'email': ['Ruslan Shukhanov <ru2020slan@yandex.ru>', 'Beqa Gozalishvili <beqaprogger@gmail.com>', "Aleksandr Lin'kov <kvark128@yandex.ru>", 'alexander Yashin <a.jaszyn@ya.ru>'],
    },
    'sk': {
        'lang':'Slovak',
    ...
    'zh_CN': {
        ...
        'email': ['vgjh2005@gmail.com', 'jiangtiandao901647@gmail.com', 'manchen0528@gmail.com', 'sysking1024@gmail.com', 'dingpengyu06@gmail.com'],
    },
    'zh_HK': {
