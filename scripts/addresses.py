...
addresses = {
    ...
    'fr': {
        'lang':'French',
        'email': ['Michel such <michel.such@free.fr>', 'Patrick ZAJDA <patrick@zajda.fr>', 'Remy Ruiz <remyruiz@gmail.com>', 'Abdelkrim Bensaid <abdelkrim.bensaid@free.fr>', 'Cyrille Bougot <cyrille.bougot2@laposte.net>', 'Corentin Bacqué-Cazenave <corentin@progaccess.net>'],
    },
    'ga': {
        'lang': 'Gaeilge',
    ...
    'is': {
        'lang':'Icelandic',
        'email': ['Birkir R. Gunnarsson <birkir.gunnarsson@gmail.com>', 'Eythor Thrastarsson <eythor364@gmail.com>', 'Hlynur Hreinsson <hm.hreinsson@gmail.com>'],
    },
    'it': {
        'lang':'Italian',
    ...
    'mk': {
        'lang':'Macedonian',
        'email': ['zvonimir stanecic <9a5dsz@gozaltech.org>', 'Ertay Shashko <ertay@outlook.com>', 'Aleksandar <glupav@gmail.com>', 'Kiko Lazarev <kristijan.lazarev@gmail.com>'],
    },
    'mn': {
        'lang':'Mongolian',
    ...
    'zh_TW': {
        ...
        'email': ['wangjanli@gmail.com', 'maro.zhang@gmail.com', 'Aaron Wu <waaron2000@gmail.com>', 'Victor Cai <surfer0627@gmail.com>', 'haach111000@gmail.com'],
    },
}
