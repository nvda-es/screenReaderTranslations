...
addresses = {
    ...
    'hr': {
        'lang': 'Croatian',
        'email': ['Hrvoje Katic <hrvojekatic@gmail.com>', 'Zvonimir Stanecic <9a5dsz@gozaltech.org>', 'Mario Percinic <mario.percinic@gmail.com>', 'Tea Turkovic <tturkovi@gmail.com>'],
    },
    'hu': {
        'lang': 'Hungarian',
    ...
    'pl': {
        'lang':'Polish',
        'email': ['Grzegorz Zlotowicz <grzezlo@wp.pl>', 'Patryk Faliszewski <patric3031@wp.pl>', 'Zvonimir Stanecic <9a5dsz@gozaltech.org>', 'Dorota Krac <dorkakrac@yandex.com>', 'Piotr Rakowski <kontakt@piotrrakowski.net>', 'Grzegorz Zlotowicz <g.zlotowicz@dzdn.pl>', 'Hubert Meyer <killer@tyflonet.com>' ],
    },
    'pt_BR': {
    ...
    'ro': {
        'lang': 'Romanian',
        'email': ['Dan Pungă <dan.punga@gmail.com>', 'Florian Ionașcu <florianionascu@hotmail.com>', 'Alexandru Matei <alexandrumateistelian@gmail.com>', 'Nicuşor Untilă <nicusoruntila@yahoo.com>', 'Adriani Ionuț Botez <ionutz_tero@yahoo.com>', 'Dragoș Grecianu <grecianu.dragos@gmail.com>'],
    },
    'ru': {
        'lang': 'Russian',
