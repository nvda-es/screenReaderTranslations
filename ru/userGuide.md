...
|Увеличить на единицу текущий параметр синтезатора |NVDA+Control+↑ |NVDA+Shift+Control+↑ |Увеличивает текущий параметр синтезатора, который вы выбрали. Например, увеличивает скорость, выбирает следующий голос, увеличивает громкость|
