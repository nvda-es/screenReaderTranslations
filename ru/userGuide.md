...
При желании нажмите "Стрелку вниз", чтобы ознакомиться с лицензионным соглашением.
1. Нажмите "tab", чтобы перейти к флажку "Я согласен", затем нажмите "пробел", чтобы установить его.
1. Нажимайте "tab", чтобы переходить к вариантам, затем нажмите `enter` на нужном.
...
При установке также предлагается создать ярлыки в меню "Пуск" и на рабочем столе, а также разрешить запуск NVDA с помощью "control+alt+n".
...
Все команды настраиваются, поэтому для этих функций используются сочетания клавиш по умолчанию.
...
| Название |Desktop key |Laptop key |Описание|
|---|---|---|---|
...
Чтобы изменить вид дополнений, измените активную вкладку списка дополнений, используя сочетание клавиш `ctrl+tab`.
Вы также можете перейти на список вкладок многостраничного диалога и перемещаться по нему с помощью клавиш "Стрелка влево" и "Стрелка вправо".
